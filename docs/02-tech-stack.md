...
There are two independent React apps:

| App | Directory | Port | Purpose |
|---|---|---|---|
| Staff app | `/web` | 5500 | Restaurant staff — orders, menus, reservations, etc. |
| Admin app | `/admin` | 5502 | Platform administration — tenant management, billing, flags, health |

Both apps share the same stack (React 19, TypeScript ~6, MST 7, Tailwind v4, TanStack Router v1) but are fully independent Vite projects with separate `package.json`, `tsconfig.json`, and `vite.config.ts`.
